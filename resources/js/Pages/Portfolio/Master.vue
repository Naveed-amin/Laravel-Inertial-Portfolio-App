<template>
    <div class="preloader" :class="{ 'active': loading, 'done': !loading }">
                        ...
                        <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                            ...
                            <div class="hexagon-menu clear">
                                <div class="hexagon-item">
                                    ...
                                    <Link href="/portfolio/welcome" class="hex-content">
                                ...
                                <div class="hexagon-item">
                                    ...
                                    <Link href="/portfolio/about" class="hex-content">
                                        <span class="hex-content-inner">
                                            <span class="icon">
                                ...
                                <div class="hexagon-item">
                                    ...
                                    <Link href="/portfolio/services" class="hex-content">
                                        <span class="hex-content-inner">
                                            <span class="icon">
                                ...
                                <div class="hexagon-item">
                                    ...
                                    <Link href="/portfolio/resume" class="hex-content">
                                        <span class="hex-content-inner">
                                            <span class="icon">
                                                <i class="tf-tools"></i>
                                            </span>
                                ...
                                <div class="hexagon-item">
                                    ...
                                    <Link href="/portfolio/works" class="hex-content">
                                        <span class="hex-content-inner">
                                            <span class="icon">
                                ...
                                <div class="hexagon-item">
                                    ...
                                    <Link href="/portfolio/testimonials" class="hex-content">
                                        <span class="hex-content-inner">
                                            <span class="icon">
                                                <i class="tf-chat"></i>
                                            </span>
                                ...
                                <div class="hexagon-item">
                                    ...
                                    <Link href="/portfolio/contact" class="hex-content">
                                        <span class="hex-content-inner">
                                            <span class="icon">
...
// lifecycle hooks
onMounted(() => {
  // Execute these actions when the component is mounted
  window.addEventListener("load", () => {

      loading.value = false; // Hide preloader after a delay
